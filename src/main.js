...
/* Логика «Написать» вынесена в nav.js — initNav() вызван выше, общая
   для всех страниц. */

/* CONTACT MODAL — кнопки hero и секции contact открывают форму поверх
   страницы вместо скролла к ней (см. #contact-modal в разметке). Логика
   вынесена в contact-modal.js — общий модуль для главной и статей вроде
   growth-system.html, у каждой такой страницы своя копия разметки
   #contact-modal, а открытие/закрытие/отправка формы одни на всех. */
initContactModal();
