/* NAV — общий модуль шапки и нижней панели, вызывается из всех entry
   ...
   её показывает CSS (.tabbar.is-hidden:has(:focus-visible)) — только
   реальный фокус с клавиатуры, программный .focus(), которым эта же
   функция возвращает фокус на «Написать» после тапа, панель не держит.
   Пока фокус в текстовом поле — скрыта, чтобы не висеть над клавиатурой.
